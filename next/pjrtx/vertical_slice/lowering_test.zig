...
test "compiler middle records Shardy-aware passes fusion placement and collectives" {
    const fixture: []u8 = try runfiles.readRunfile(std.testing.allocator, "next/pjrtx/fixtures/shardy_tiny_mesh.mlir");
...
test "unsupported collective fails during compiler-middle lowering gate" {
    const fixture: []u8 = try runfiles.readRunfile(std.testing.allocator, "next/pjrtx/fixtures/unsupported_all_reduce.mlir");
    defer std.testing.allocator.free(fixture);
...
test "collective_group_channel_verify parses channels and rejects topology drift" {
    const channel_fixture: []u8 = try runfiles.readRunfile(std.testing.allocator, "next/pjrtx/fixtures/all_reduce_channel.mlir");
...
test "tile_shape_select bounds large NPU matrix tiles before backend binding" {
    const fixture: []u8 = try runfiles.readRunfile(std.testing.allocator, "next/pjrtx/fixtures/large_tiling.mlir");
    defer std.testing.allocator.free(fixture);
...
test "broadcast_simplify removes identity broadcast before fusion and lowering" {
    const fixture: []u8 = try runfiles.readRunfile(std.testing.allocator, "next/pjrtx/fixtures/identity_broadcast.mlir");
    defer std.testing.allocator.free(fixture);
...
test "reshape_transpose_fold removes identity reshape and transpose before target legality" {
    const fixture: []u8 = try runfiles.readRunfile(std.testing.allocator, "next/pjrtx/fixtures/identity_reshape_transpose.mlir");
    defer std.testing.allocator.free(fixture);
...
test "non-identity transpose is rejected by no-fallback target legality" {
    const fixture: []u8 = try runfiles.readRunfile(std.testing.allocator, "next/pjrtx/fixtures/non_identity_transpose.mlir");
    defer std.testing.allocator.free(fixture);
