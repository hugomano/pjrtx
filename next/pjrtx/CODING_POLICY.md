...
New architecture code lives under `//next/pjrtx/...` and follows the implementation
...
- Do not add new dependencies on `//next/pjrtx/core`; new types live in the package
