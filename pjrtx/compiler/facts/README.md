...
- `//pjrtx/compiler`
- `//pjrtx/backend`
- `//pjrtx/runtime`, as immutable graph inputs for allocation/profile planning
- `//pjrtx/tests/vertical_slice`

Temporary bridge:

- `//pjrtx/core` re-exports these names only while the legacy `TraceReport`
